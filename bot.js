...
bot.on("ready", function () {
	...
	console.log("******************************************************************");
	console.log("*- flan-chanbot -*");
	console.log("Author: FlandereScarlet");
...
commands.myinfo = {
	...
	longDesc: "Displays various information about the user that executed the command.",
	main: function (bot, msg) {
...
//make the bot repeat shit
commands.say ={
	name: "say",
	desc: "make the bot say shit",
	longDesc:"make the bot say shit with more shit.",
	main: function(bot,msg,suffix) {
		bot.sendMessage(msg.channel, suffix);
	}
}
//a talk command made using cleverbot-node
commands.talk = {
	name: "talk",
	desc: "talk with the bot (duh).",
	//todo: make the bot respond to mention + suffix.
	longDesc: "converse with the bot. We cannot gurantee a 100% quality chat with her anyways kek.",
	main: function (bot, msg, suffix) {
